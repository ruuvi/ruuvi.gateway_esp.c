...
nrf52_fw_ver_get_str(const ruuvi_nrf52_fw_ver_t* const p_nrf52_fw_ver)
{
    ...
    snprintf(
        ...
        "v%u.%u.%u",
        (printf_uint_t)((p_nrf52_fw_ver->version >> BIT_IDX_OF_BYTE_3) & BYTE_MASK),
        (printf_uint_t)((p_nrf52_fw_ver->version >> BIT_IDX_OF_BYTE_2) & BYTE_MASK),
        (printf_uint_t)((p_nrf52_fw_ver->version >> BIT_IDX_OF_BYTE_1) & BYTE_MASK));
