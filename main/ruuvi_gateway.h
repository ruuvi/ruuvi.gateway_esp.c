...
#define RUUVI_LARGEST_FREE_BLOCK_LIM_KIB (8U)
...
#define RUUVI_CHECK_FOR_FW_UPDATES_DELAY_AFTER_REBOOT_SECONDS  (2 * 60U * 60U)
...
#define RUUVI_HTTPS_POST_TLS_IN_CONTENT_LEN  (8192)
#define RUUVI_HTTPS_POST_TLS_OUT_CONTENT_LEN (4096)
