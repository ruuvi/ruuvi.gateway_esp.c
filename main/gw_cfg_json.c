...
static bool
gw_cfg_json_add_items_http(cJSON *p_json_root, const ruuvi_gateway_config_t *p_cfg, const bool flag_hide_passwords)
{
...
static bool
gw_cfg_json_add_items_http_stat(cJSON *p_json_root, const ruuvi_gateway_config_t *p_cfg, const bool flag_hide_passwords)
{
...
static bool
gw_cfg_json_add_items_lan_auth(cJSON *p_json_root, const ruuvi_gateway_config_t *p_cfg, const bool flag_hide_passwords)
{
...
static bool
gw_cfg_json_add_items(cJSON *p_json_root, const ruuvi_gateway_config_t *p_cfg, const bool flag_hide_passwords)
{
    ...
    if (!gw_cfg_json_add_items_http(p_json_root, p_cfg, flag_hide_passwords))
    {
        return false;
    }
    if (!gw_cfg_json_add_items_http_stat(p_json_root, p_cfg, flag_hide_passwords))
    {
        return false;
    }
    if (!gw_cfg_json_add_items_mqtt(p_json_root, p_cfg, flag_hide_passwords))
    {
        return false;
    }
    if (!gw_cfg_json_add_items_lan_auth(p_json_root, p_cfg, flag_hide_passwords))
    {
        return false;
    }
...
gw_cfg_json_generate(
    const ruuvi_gateway_config_t *const p_gw_cfg,
...
bool
gw_cfg_json_generate_full(const ruuvi_gateway_config_t *const p_gw_cfg, cjson_wrap_str_t *const p_json_str)
{
    return gw_cfg_json_generate(p_gw_cfg, p_json_str, false);
}

bool
gw_cfg_json_generate_without_passwords(const ruuvi_gateway_config_t *const p_gw_cfg, cjson_wrap_str_t *const p_json_str)
{
...
gw_cfg_json_parse(const char *const p_json_str, ruuvi_gateway_config_t *const p_gw_cfg, bool *const p_flag_modified)
{
    *p_flag_modified = false;
    ...
    gw_cfg_json_parse_cjson(p_json_root, false, p_gw_cfg, &dev_info);
