...
enum event_history_e
{
    ...
    EVENT_HISTORY_SIG_ON_RECV_ADV                 = ADV_POST_SIG_ON_RECV_ADV,
    ...
    EVENT_HISTORY_SIG_ACTIVATE_SENDING_STATISTICS = ADV_POST_SIG_ACTIVATE_SENDING_STATISTICS,
    ...
    EVENT_HISTORY_SIG_ACTIVATE_CFG_MODE           = ADV_POST_SIG_ACTIVATE_CFG_MODE,
    EVENT_HISTORY_SIG_DEACTIVATE_CFG_MODE         = ADV_POST_SIG_DEACTIVATE_CFG_MODE,
