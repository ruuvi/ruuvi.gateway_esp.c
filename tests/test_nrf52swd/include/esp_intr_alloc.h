...
#define ESP_INTR_FLAG_LOWMED \
    (ESP_INTR_FLAG_LEVEL1 | ESP_INTR_FLAG_LEVEL2 \
     | ESP_INTR_FLAG_LEVEL3) ///< Low and medium prio interrupts. These can be handled in C.
#define ESP_INTR_FLAG_HIGH \
    (ESP_INTR_FLAG_LEVEL4 | ESP_INTR_FLAG_LEVEL5 | ESP_INTR_FLAG_LEVEL6 \
     | ESP_INTR_FLAG_NMI) ///< High level interrupts. Need to be handled in assembly.

#define ESP_INTR_FLAG_LEVELMASK \
    (ESP_INTR_FLAG_LEVEL1 | ESP_INTR_FLAG_LEVEL2 | ESP_INTR_FLAG_LEVEL3 | ESP_INTR_FLAG_LEVEL4 | ESP_INTR_FLAG_LEVEL5 \
     | ESP_INTR_FLAG_LEVEL6 | ESP_INTR_FLAG_NMI) ///< Mask for all level flags
 ...
 */
int
esp_intr_get_cpu(intr_handle_t handle);
 ...
 */
int
esp_intr_get_intno(intr_handle_t handle);
 ...
 */
esp_err_t
esp_intr_set_in_iram(intr_handle_t handle, bool is_in_iram);

/**
 * @brief Disable interrupts that aren't specifically marked as running from IRAM
 */
void
esp_intr_noniram_disable(void);

/**
 * @brief Re-enable interrupts disabled by esp_intr_noniram_disable
 */
void
esp_intr_noniram_enable(void);
 ...
 */
void
esp_intr_enable_source(int inum);
 ...
 */
void
esp_intr_disable_source(int inum);
 ...
 */
static inline int
esp_intr_flags_to_level(int flags)
{
