 ...
 *
 * Semantics are the same as standard free(), only the argument 'p' must be NULL or have been allocated in the specified
 * heap.
 *
 * @param heap Handle to a registered heap.
 ...
 *
 * Semantics are the same as standard realloc(), only the argument 'p' must be NULL or have been allocated in the
 * specified heap.
 *
 * @param heap Handle to a registered heap.
 * @param p NULL, or a pointer previously returned from multi_heap_malloc() or multi_heap_realloc() for the same heap.
 ...
 *
 * @param heap Handle to a registered heap.
 * @param p Pointer, must have been previously returned from multi_heap_malloc() or multi_heap_realloc() for the same
 * heap.
 *
 ...
 *
 * The lock argument is supplied to the MULTI_HEAP_LOCK() and MULTI_HEAP_UNLOCK() macros, defined in
 ...
 */
void
multi_heap_dump(multi_heap_handle_t heap);
 ...
 */
bool
multi_heap_check(multi_heap_handle_t heap, bool print_errors);
 ...
 */
size_t
multi_heap_free_size(multi_heap_handle_t heap);
 ...
 */
size_t
multi_heap_minimum_free_size(multi_heap_handle_t heap);
