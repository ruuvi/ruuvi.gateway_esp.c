...
TEST_F(TestGwCfgJson, gw_cfg_json_generate_parse_generate_default) // NOLINT
{
    ...
    ASSERT_EQ(string(""), gw_cfg2.eth.eth_static_ip);
    ASSERT_EQ(string(""), gw_cfg2.eth.eth_netmask);
    ASSERT_EQ(string(""), gw_cfg2.eth.eth_gw);
    ASSERT_EQ(string(""), gw_cfg2.eth.eth_dns1);
    ASSERT_EQ(string(""), gw_cfg2.eth.eth_dns2);
    ...
    ASSERT_EQ(string(RUUVI_GATEWAY_HTTP_DEFAULT_URL), gw_cfg2.http.http_url);
    ASSERT_EQ(string(""), gw_cfg2.http.http_user);
    ASSERT_EQ(string(""), gw_cfg2.http.http_pass);
...
TEST_F(TestGwCfgJson, gw_cfg_json_generate_parse_generate_not_default) // NOLINT
{
    ...
    ASSERT_EQ(string("192.168.1.10"), gw_cfg2.eth.eth_static_ip);
    ASSERT_EQ(string("255.255.255.0"), gw_cfg2.eth.eth_netmask);
    ASSERT_EQ(string("192.168.1.1"), gw_cfg2.eth.eth_gw);
    ASSERT_EQ(string("8.8.8.8"), gw_cfg2.eth.eth_dns1);
    ASSERT_EQ(string("4.4.4.4"), gw_cfg2.eth.eth_dns2);
    ...
    ASSERT_EQ(string("https://myserver1.com"), gw_cfg2.http.http_url);
    ASSERT_EQ(string("h_user1"), gw_cfg2.http.http_user);
    ASSERT_EQ(string("h_pass1"), gw_cfg2.http.http_pass);
