...
TEST_F(TestGwCfgBlob, test_gw_cfg_blob_convert_1) // NOLINT
{
    ...
    ASSERT_EQ(string(""), gw_cfg.mqtt.mqtt_client_id);
...
TEST_F(TestGwCfgBlob, test_gw_cfg_blob_convert_2) // NOLINT
{
    ...
    ASSERT_EQ(string("my_client"), gw_cfg.mqtt.mqtt_client_id);
    ASSERT_EQ(string("m_user1"), gw_cfg.mqtt.mqtt_user);
    ASSERT_EQ(string("m_pass1"), gw_cfg.mqtt.mqtt_pass);

    ASSERT_EQ(false, gw_cfg.http.use_http);
    ASSERT_EQ(string("https://myserver.com/record"), gw_cfg.http.http_url);
    ASSERT_EQ(string("h_user1"), gw_cfg.http.http_user);
    ASSERT_EQ(string("h_pass1"), gw_cfg.http.http_pass);
